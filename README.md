checkout branch upstream+origin

You need to [Install OpenMPI](http://lsi.ugr.es/jmantas/pdp/ayuda/datos/instalaciones/Install_OpenMPI_en.pdf) before install python dependencies.
